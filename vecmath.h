...
class Vector3 {
public:
  Vector3() : x(0), y(0), z(0), u(0), v(0) {}
  Vector3(const Vector3& p) : x(p.x), y(p.y), z(p.z), u(p.u), v(p.v) {}
  Vector3(double _x, double _y, double _z) : x(_x), y(_y), z(_z) {}
  Vector3(double _x, double _y, double _z, double _u, double _v) :
...
class Point3 {
public:
  Point3() : x(0), y(0), z(0), u(0), v(0) {}
  Point3(const Point3& p) : x(p.x), y(p.y), z(p.z), u(p.u), v(p.v) {}
  Point3(double _x, double _y, double _z) : x(_x), y(_y), z(_z) {}
  Point3(double _x, double _y, double _z, double _u, double _v) :
		x(_x), y(_y), z(_z), u(_u), v(_v) {}
